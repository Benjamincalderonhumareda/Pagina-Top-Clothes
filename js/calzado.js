...
function CalzadosCard({ calzado }) {
  const handleComprar = () => {
    ...
    alert(`(${calzado.title})  Agregado al carrito.`);
  ...
  return (
    <div className="bg-[#D9D9D9] rounded-md p-3 hover:shadow-lg transition-transform duration-200 hover:scale-105">
      ...
      <div className="mt-3 text-xs text-gray-700" style={{ fontFamily: "Abel, sans-serif" }}>
        ...
        className="mt-2 w-full bg-black text-white text-sm py-1 rounded-md hover:bg-gray-800 transition" style={{ fontFamily: "Abel, sans-serif" }}>
          Comprar
        </button>
      </div>
    </div>
