...
function RopasCard({ ropa }) {
  const handleComprar = () => {
    ...
    alert(`(${ropa.title}) Agregado al carrito.`);
  ...
  return (
    <div className="bg-[#D9D9D9] rounded-md p-4 hover:shadow-lg transition-transform duration-200 hover:scale-105">
      ...
      <button
        ...
        className="w-full bg-black text-white py-2 rounded-md font-semibold hover:bg-gray-800 transition-all duration-200"
      >
        Comprar
      </button>
    </div>
  ...
  return (
    <section className="mb-12">
      <h2
        ...
        style={{ fontFamily: "Karma", fontWeight: 600 }}
      >
        {title}
      </h2>
    ...
    <div className="min-h-screen bg-white">
      <div className="container mx-auto py-8">
        <h1 className="text-4xl font-bold text-center text-gray-900 mb-10">
          LLEVATE LA MEJOR ROPA CON TOP CLOTHES
        </h1>
